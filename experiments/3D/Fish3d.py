...
# Define columns
feature_columns = ['Length1', 'Height']  # Selected features for fitting the hyperplane
target_column = 'Weight'  # Target variable for distance-based R² calculation

# Generate a regression dataset with 6 features
data = pd.read_csv(r"D:\course\P\Project4\pythonProject\3\Fish.csv")

data_selected = data[['Length1', 'Height', 'Weight']]
