...
# Define columns
feature_columns = ['DIS', 'LSTAT']  # Selected features for fitting the hyperplane
target_column = 'MEDV'  # Target variable for distance-based R² calculation

# Generate a regression dataset with 6 features
data = pd.read_csv(r"D:\course\P\Project4\pythonProject\3\boston.csv")

data_selected = data[['DIS', 'LSTAT', 'MEDV']]
